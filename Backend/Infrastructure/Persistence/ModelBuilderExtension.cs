    ...
    public static class ModelBuilderExtension
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Subasta>().HasData(
                new Subasta { id = 1, vendedor_id = 1, categoria_id = 1, titulo = "Celular", descripcion = "Celular Samsung", url_imagen = "https://tiendaonline.movistar.com.ar/media/catalog/product/cache/d24a34bded6d2df740ef66d66d2112c9/s/2/s25_-_ultra_-_256_1.png", precio_base = 30000, incremento_minimo = 1000, fecha_inicio = DateTime.UtcNow, fecha_fin = DateTime.UtcNow.AddMinutes(30), estado = (EstadoSubasta)2 },
                new Subasta { id = 2, vendedor_id = 1, categoria_id = 2, titulo = "Figura de acción", descripcion = "Figura de acción de colección", url_imagen = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQHSF2APQXLBUahZ48y6aGccqKPsRoJ7ONOp3AMz6m3Mw&s=10", precio_base = 5000, incremento_minimo = 500, fecha_inicio = DateTime.UtcNow, fecha_fin = DateTime.UtcNow.AddMinutes(1), estado = (EstadoSubasta)2},
        ...
        public static void SeedOpcional(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Subasta>().HasData(
                new Subasta { id = 6, vendedor_id = 1, categoria_id = 2, titulo = "Peluche", descripcion = "Un peluche de edición limitada.", url_imagen = "https://thumbs.dreamstime.com/b/oso-del-peluche-1768036.jpg", precio_base = 100, incremento_minimo = 10, fecha_inicio = DateTime.UtcNow, fecha_fin = DateTime.UtcNow.AddHours(5), estado = (EstadoSubasta)2 },
                new Subasta { id = 7, vendedor_id = 1, categoria_id = 3, titulo = "Remera", descripcion = "Una remera de alta calidad.", url_imagen = "https://sixs.com.ar/wp-content/uploads/2026/08/PORTADA-344-600x900.jpg", precio_base = 500, incremento_minimo = 50, fecha_inicio = DateTime.UtcNow, fecha_fin = DateTime.UtcNow.AddHours(6), estado = (EstadoSubasta)2 },
                new Subasta { id = 8, vendedor_id = 1, categoria_id = 1, titulo = "Notebook", descripcion = "Una Notebook Dell.", url_imagen = "https://media.ambito.com/p/9db8f0c465df0f5134267372ffb550ae/adjuntos/239/imagenes/039/404/0039404820/730x0/smart/imagepng.png", precio_base = 25000, incremento_minimo = 2500, fecha_inicio = DateTime.UtcNow, fecha_fin = DateTime.UtcNow.AddHours(12), estado = (EstadoSubasta)2 },
                new Subasta { id = 9, vendedor_id = 1, categoria_id = 4, titulo = "Auto Ford", descripcion = "Un auto de marca Ford.", url_imagen = "https://media.istockphoto.com/id/2168361346/es/foto/coche-ford-fiesta.jpg?s=612x612&w=0&k=20&c=x8mYzGQlJYarW3bUYe-ENF2zYWa5-Q4J9UdGzxRAbLM=", precio_base = 2000, incremento_minimo = 1000, fecha_inicio = DateTime.UtcNow.AddHours(24), fecha_fin = DateTime.UtcNow.AddMinutes(1), estado = (EstadoSubasta)2 },
                new Subasta { id = 10, vendedor_id = 1, categoria_id = 5, titulo = "Casa", descripcion = "Una casa de lujo", url_imagen = "https://media.revistagq.com/photos/5cfa20d7cb3e974d1a5fc3dd/1:1/w_2700,h_2700,c_limit/GettyImages-525440005.jpg", precio_base = 500000, incremento_minimo = 5000, fecha_inicio = DateTime.UtcNow, fecha_fin = DateTime.UtcNow.AddHours(20), estado = (EstadoSubasta)2 }
            );
        }
    }
}
